...
use Keiwen\Competition\Type\CompetitionChampionshipBrawl;
use Keiwen\Competition\Type\CompetitionChampionshipBubble;
use Keiwen\Competition\Type\CompetitionChampionshipDuel;
use Keiwen\Competition\Type\CompetitionChampionshipPerformances;
use Keiwen\Competition\Type\CompetitionChampionshipRace;
use Keiwen\Competition\Type\CompetitionChampionshipSwiss;
use Keiwen\Competition\Type\CompetitionEliminationContest;
use Keiwen\Competition\Type\CompetitionEliminationThreshold;
use Keiwen\Competition\Type\CompetitionTournamentDoubleElimination;
use Keiwen\Competition\Type\CompetitionTournamentDuel;
use Keiwen\Competition\Type\CompetitionTournamentGauntlet;
use Keiwen\Competition\Type\CompetitionTournamentSwap;
use Keiwen\Competition\Game\GameDuel;
use Keiwen\Competition\Ranking\RankingBrawl;
use Keiwen\Competition\Ranking\RankingDuel;
use Keiwen\Competition\Ranking\RankingPerformances;
use Keiwen\Competition\Ranking\RankingRace;
